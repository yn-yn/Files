...
它被用于存在高度不确定性、复杂性和非线性的情况。模式识别、自动控制、决策、数据分类是其中的几个例子。FL框架的假设是由值得注意的人类处理基于感知的信息的能力来鼓励的。它使用人类提供的规则（If-Then）并将这些规则转换为其数学等价物。这简化了系统设计者和计算机的工作，以获得关于系统在现实世界中的执行方式的更正确的信息，因此它被用于移动机器人的路径规划。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1MjY0OTczMywtNTExOTExMzk2LDIwOT
EzNTM0MDcsLTE4NTkzODc2NSw5ODM1NDg5NDMsMTgyNDc5ODE5
NCwtMTQ5NzE1MTEwOCwtMTUwMjQwMjg3MiwtODE1MjQxOTAwLC
0yMTIwNjIwODEzLDExOTc3Mjk2NTksLTE1OTQ5NTU3MzMsMTUw
NjI0MTAyNF19
-->