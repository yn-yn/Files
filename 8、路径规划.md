...
ABC算法是一种基于蜂群的智能方法，其灵感来自于蜜蜂寻找食物的活动（图20），由Kharaboga提出。ABC算法是一种基于群体的策略，由一群固有的解决方案（蜜蜂的食物来源）组成。它在使用上相对简单，处理速度快，是蜂群算法领域中基于种群的随机搜索方法。ABC的食物搜索周期由以下三个规则组成。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkyMjA0MjIyMCwtMTI4OTU2OTIzOCw4Mz
QyNDc3OSwtMzA4Njg0OTg5LC03Mjg1ODM3NTAsLTEyMzgwNTIw
NzMsLTMwMzYxMzQ2M119
-->